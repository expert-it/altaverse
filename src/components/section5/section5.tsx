...
function Section5() {
  ...
  return (
    ...
    <div className='scroll-effect what-sec flex items-center justify-between'>
        ...
        <div className='what-wrap'>
          ...
          <div className='what-cnt'>
            <div className='cnt-para'>
              ...
              Create your AI Agent to find choice of products for your investments all around the world.</p>
            </div>
            ...
            <div className='cnt-list'>
              <ul>
                <li>Exclusive - allow to conver to ADAT Dao . Start at $3k. Unlimited DeSA. </li>
